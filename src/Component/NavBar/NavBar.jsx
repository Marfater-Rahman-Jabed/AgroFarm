                                ...
                                <ul className="menu menu-vertical px-1">
                                    ...
                                    <div className="dropdown dropdown-hover mt-1 ">
                                        ...
                                        <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100  w-64 ms-24">
                                            ...
                                            <li className='hover:bg-orange-500 hover:text-white' onClick={() => setOpen(prev => !prev)}><Link to='/productsOilSeed' >Grain & Oilseed</Link ></li>
                                    ...
                                    <div className='px-3 rounded-0 mt-2'><NavLink to='/login' className='border-separate  hover:border-b-2 hover:border-orange-500 font-semibold ' onClick={() => setOpen(prev => !prev)}>LOGIN</NavLink></div>
                                </ul>
                            </ul>
                        }
                    </div>
