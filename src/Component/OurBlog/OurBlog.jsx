                ...
                >
                    <div className=''>
                        <div className="card mx-3  bg-base-100 shadow-xl">
                            <figure><img src={flower} alt="Shoes" className="w-full" /></figure>
                    ...
                    <div className=' '>
                        <div className="card mx-3 bg-base-100 shadow-xl">
                            <figure><img src={hen} alt="Shoes" className="w-full" /></figure>
                            <div className="card-body">
                                <h3>15 August 2023</h3>
                    ...
                    <div className=' '>
                        <div className="card mx-3 bg-base-100 shadow-xl">
                            <figure><img src={aboutphoto} alt="Shoes" className="w-full" /></figure>
                            <div className="card-body">
                                <h3>15 August 2023</h3>
