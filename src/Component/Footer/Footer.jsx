...
const Footer = () => {
    return (
        <div className='bg-slate-200'>
            ...
            <footer className="footer p-10 bg-slate-400 text-black font-semibold">
                <nav>
                    <img src={logo} alt="" className='w-36 h-36 rounded-full' />
                </nav>
                <nav>
            ...
            <footer className="footer px-10 py-4 border-t bg-slate-400 text-black font-semibold">
