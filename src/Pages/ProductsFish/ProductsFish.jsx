...
const ProductsFish = () => {
    ...
    const { data: myData = [], refetch } = useQuery({
        ...
        queryFn: async () => {
            // setIsLoading(true)
            const res = await fetch(`http://localhost:5000/productsFish`)
            const data = res.json()
            // setIsLoading(false)
            return data;
        }
    ...
    const handleDelete = (id) => {
        ...
        fetch(`http://localhost:5000/deleteFishProducts/${id}`, {
            method: 'DELETE',
            ...
            .then(data => {
                ...
                refetch(`http://localhost:5000/productsFish`)
            })
    }
        ...
        fetch(`https://api.imgbb.com/1/upload?key=${imageKey}`, {
            ...
            .then(image => {
                ...
                if (image.success) {
                    ...
                    fetch(`http://localhost:5000/uploadFishProduct`, {
                        method: 'POST',
                        headers: {
